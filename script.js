(function () {
    ...
    const MAGNUS_CHANNEL = 'https://www.youtube.com/@dicasmagnusofc';
    // =================================================================
    // 1. UTILITÁRIOS
    // =================================================================
    const Utils = {
    ...
    // =================================================================
    // 3. ESTILOS (incluindo estilo botão Magnus)
    // =================================================================
    ...
    const css = `
        :root {
            ...
            --magnus: #ff0000; --magnus-hover: #cc0000;
        }
        #${APP_ID}_overlay {
        ...
        /* Botão crédito Magnus */
        .magnus-btn {
            display: inline-block; margin-top: 4px; padding: 5px 10px;
            background: var(--magnus); color: white !important; font-size: 11px; font-weight:bold;
            border-radius: 6px; text-decoration: none; text-align:center; transition:0.2s;
        }
        .magnus-btn:hover { background: var(--magnus-hover); transform:scale(1.03); }
    ...
    class RedacaoBypassEngine {
        ...
        applyDrag(handle, container) {
            ...
            const onDown = (e) => {
                if (e.target.closest('.rb-win-btn, .magnus-btn')) return;
        ...
        renderConfigPanel() {
            ...
            this.ui.innerHTML = `
                ...
                <a href="${MAGNUS_CHANNEL}" target="_blank" rel="noopener noreferrer" class="magnus-btn">💻 Criado por @Magnus</a>
            `;
